...
python main.py --dataset_name "CIFAR10" --image_size 32 --batch_size 128 --mode "all" --size 32 --lr 0.1 --model "ResNet18" --early_stop 5000 --local_iter 5 --warmup_step 5 --optimization 'VRSAM' --wd 0.0005 --gamma 0.998 
python main.py --dataset_name "CIFAR10" --image_size 32 --batch_size 128 --mode "all" --size 32 --lr 0.1 --model "ResNet18" --early_stop 5000 --local_iter 5 --warmup_step 5 --optimization 'VRSAMProx' --wd 0.0005 --gamma 0.998 
