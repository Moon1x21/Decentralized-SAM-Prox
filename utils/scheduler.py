...
class Warmup_MultiStepLR(LambdaLR):
    def __init__(self, optimizer, warmup_step=10, milestones=[150, 225], gamma=0.1, init_rate=0.0, last_epoch=-1):
...
class Local_MultiStepLR(LambdaLR):
    def __init__(self, optimizer, warmup_step=10, gamma=0.1, init_rate=0.0, last_epoch=-1):
        self.optimizer = optimizer
        self.warmup_step = warmup_step
        self.milestones_rate = 1.0
        self.gamma = gamma
        self.init_rate = init_rate
        self.last_epoch = last_epoch
        super(Local_MultiStepLR, self).__init__(optimizer, self.lr_lambda, last_epoch=last_epoch)
